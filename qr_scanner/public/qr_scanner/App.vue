		...
		<div id="qrCard" class="card qr-card">
			<div class="qr-section" role="region" aria-live="polite" aria-atomic="true">
				...
				<InputRow
					ref="inputRef"
					:disabled="
						store.state.inFlight || store.state.isLocked || store.state.mode !== 'none'
					"
					:autofocus="true"
				...
				<div class="qr-help">
					States are displayed as opaque overlays inside the card. On duplicate, a red
					lock requires admin password.
				</div>
			</div>
